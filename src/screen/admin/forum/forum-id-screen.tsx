...
export default function ForumIDScreen({ forumId }: { forumId: string }) {
  ...
  const answerUrl = '/api/questions/answers';
  const tagName = 'tags';
  ...
  const deleteMutation = useMutation(
    (data: Record<string, any>) => {
      return axiosinstance.delete(`${answerUrl}/${data.id}`);
    },
    {
      onSuccess: (data) => {
  ...
  return (
    <>
      <section className='w-full flex flex-row justify-start items-center flex-nowrap'>
                      ...
                      <div className=' flex flex-row justiyf-center items-start gap-4 w-full'>
                        ...
                        <div className='w-full h-full flex flex-row justify-center items-center gap-3 box-border'>
                          ...
                          <div className='w-max flex flex-row justify-center items-center gap-3'>
                            <button className='flex flex-row justify-center items-center gap-2 disabled:opacity-30 disabled:cursor-not-allowed'>
                              <TrashIcon
                                width={20}
                                onClick={() => {
