...
import UpdateCourse from '@/form/update-course-modal';

export default function CoursesScreen() {
  const apiUrl = '/api/courses';
  const queryName = 'courses-admin';
  ...
  return (
    <>
      {isFetching ? (
        ...
        <>
          <div className='w-full h-max flex flex-col justify-start items-start gap-5 overflow-hidden scrollbar-none box-border'>
            <div className='w-full h-max flex flex-row flex-wrap justify-start items-start gap-5 overflow-y-scroll scrollbar-none box-border'>
              {data?.data?.data?.map(
