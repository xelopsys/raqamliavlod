...
export default function StandingsTable({ id }: { id: string | number }) {
  const { standingsRowCol } = Headers();
  const router = useRouter();
  const apiUrl = `/api/contests/${id}/standings`;
  const queryName = 'standings-table';
